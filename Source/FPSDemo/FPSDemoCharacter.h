...
#include <FPSDemo/BaseWeapon.h>
#include <FPSDemo/BaseAmmo.h>
...
public:
	...
	//check if the character is currently Zoomed-in to their weapon
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Gameplay)
	bool isZoomedIn;
...
protected:
	...
	//Reload the current weapon on button press.
	void ManualReload();
	...
	//Allows the character Switch character feature
	void SwitchCharacter();

	UPROPERTY(EditAnywhere, Category = "Possession")
	AFPSDemoCharacter* otherCharater;
